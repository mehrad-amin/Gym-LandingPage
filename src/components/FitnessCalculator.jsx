    ...
    <div className="rounded-3xl border border-fitness-border bg-fitness-surface p-6 md:p-10">
      <div className="mb-6 text-center">
        ...
        <p className="mt-2 text-sm text-fitness-muted">
          مشخصات خود را وارد کنید تا انرژی پایه و تارگت‌های تمرینی شما دقیق
          تخمین زده شود.
        </p>
      </div>
      ...
      {result && (
        <div className="mt-8 grid grid-cols-1 gap-4 border-t border-fitness-border pt-6 sm:grid-cols-3">
